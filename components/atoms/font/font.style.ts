...
export const TitleTextStyled = styled.text`
    ...
    ${screenWidth && screenWidth > 750 && screenWidth < 900 && title.omerald_textStyle_laptop_Title1}
    ${screenWidth && screenWidth > 500 && screenWidth < 750 && title.omerald_textStyle_tab_Title1}
...
export const HeaderStyled_1 = styled.text`
    ...
    ${screenWidth && screenWidth > 750 && screenWidth < 900 && header.omerald_textStyle_laptop_Title1}
    ${screenWidth && screenWidth > 500 && screenWidth < 750 && header.omerald_textStyle_tab_Title1}
...
export const BodyStyled_1 = styled.text`
    ...
    ${screenWidth && screenWidth > 750 && screenWidth < 900 && body.omerald_textStyle_laptop_Body1}
    ${screenWidth && screenWidth > 500 && screenWidth < 750 && body.omerald_textStyle_tab_Body1}
...
export const BodyStyled_2 = styled.text`
    ...
    ${screenWidth && screenWidth > 750 && screenWidth < 900 && body.omerald_textStyle_Body2}
    ${screenWidth && screenWidth > 500 && screenWidth < 750 && body.omerald_textStyle_Body2}
