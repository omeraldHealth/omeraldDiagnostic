 ...
 */
export const successAlert = (msg: string): void => showToastIfNotDisplayed(msg, { type: "success" });

/**
 * Displays an info toast message.
 * @param {string} msg - The info message.
 */
export const infoAlert = (msg: string): void => showToastIfNotDisplayed(msg, { type: "info" });
 ...
 */
export const errorAlert = (msg: string): void => showToastIfNotDisplayed(msg, { type: "error" });
