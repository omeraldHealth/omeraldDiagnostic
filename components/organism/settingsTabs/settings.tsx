...
export function SettingsCommon({tabIndex,data,columns,edit,initialData,handleSubmit,settingsForm,setEdit,setAddElement,addElement,selectedValue,setSelectedValue}:any) {
    return (
          <section >
              <section className="min-h-[45vh]">
                  {!addElement ? <div className=""> 
                    ...
                    <section className="w-[50%] my-10 relative">
                      <DynamicFormCreator setSelectedValue={setSelectedValue} selectedValue={selectedValue} initial={edit && initialData} handleSubmit={handleSubmit} buttonText={edit?"update":"submit"} formProps={settingsForm}  />
                    </section>
                  }
              </section>
