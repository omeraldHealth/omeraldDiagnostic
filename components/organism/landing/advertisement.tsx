...
import { BodyText_2, HeaderText_1, HeaderText_2 } from "@components/atoms/font";
        ...
        <div className='h-auto my-20 mx-[4%] lg:mx-[10%]'>
            ...
            <section className="lg:flex gap-[2%] my-[7%] w-[100%] justify-around">
                {advertisement.map((ad,index) => {
                    return <section key={index} className="text-center bg-[#eef0fa] my-6 lg:my-0 lg:w-[33%] lg:h-[350px] p-4 lg:p-10 rounded-lg">
