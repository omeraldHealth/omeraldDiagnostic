    ...
    <div className='my-20 mx-[4%] lg:mx-[10%]'>
      ...
      <header className="h-[170px] border-2 border-gray-200 rounded-xl text-center flex mb-8 shadow-xl">
        <div className='w-[100%] h-full flex justify-center items-center'>
          <img src={advertisementBanner?.landing?.advertisementBanners[0].url} alt={advertisementBanner?.landing?.advertisementBanners[0].meta} className="object-cover w-full h-full" />
        </div>
      </header>
