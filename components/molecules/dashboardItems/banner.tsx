  ...
  return (
    <section className="relative">
      ...
      <p className="absolute top-14 left-[25%] xl:left-80 font-light text-[10px] sm:text-xs xl:text-sm text-gray-300">
        You have uploaded{' '}
        <span className="text-orange-400">{profile?.reports?.length || 0} report</span> till date, please use our add reports section to share more reports
        <br /> with your patients directly. Also, a total of{' '}
        <span className="text-orange-400">{profile?.tests?.length || 0} tests </span> are offered; please add more using the tests offered section.
      </p>
    </section>
  );
};
