...
export default function Sidebar() {
  ...
  const currentBranch = useRecoilState(branchState)
  ...
  const allowedAdminManagers  = ["+918688631831","+918553548534"]
  ...
  return (
    ...
    >
      ...
      <a href='https://omerald.com/' target={"_blank"} > @Omerald </a> 2023. <br/>All Rights Reserved.</p>
    </aside>
  );
}
