...
export const createDiagTestApi =
  diagBackendApiPath + `tests/createTest/`; // Endpoint to create diagnostic profile
export const updateDiagTestApi =
  diagBackendApiPath + `tests/updateTest/`; // Endpoint to update diagnostic profile
export const deleteDiagTestApi =
  diagBackendApiPath + `tests/deleteTest/`;
