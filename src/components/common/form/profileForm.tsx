...
export const ProfileForm = ({
  ...
  const diagnosticProfile = useSelector(
    (state: any) => state.diagnosticReducer,
  );
            ...
            {form.type === "text" && (
              ...
              >
                <Input
                  ...
                  className="border-gray-400 rounded-lg text-black font-light text-sm"
                />
              </Form.Item>
            )}
            {form.type === "email" && (
