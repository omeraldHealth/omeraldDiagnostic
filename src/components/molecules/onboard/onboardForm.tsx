          ...
          <section className="col-span-10 grid grid-cols-2 gap-4">
            ...
            >
              <Input
                ...
                placeholder="Enter your diagnostic contact"
              />
            </Form.Item>
            <Form.Item
              name="centerName"
            ...
            >
              <Input
                className="w-[100%] py-2 bg-gray-100"
                placeholder="Enter your diagnostic name"
              />
            </Form.Item>
            <Form.Item
              name="email"
            ...
            >
              <Input
                className="w-[100%] py-2 bg-gray-100"
                placeholder="Enter your diagnostic email"
              />
            </Form.Item>
          </section>
        </div>
        <div className=" grid-cols-12 gap-2 border-b-2 border-slate-200 pb-4 my-8">
          ...
          <section className="col-span-10 grid grid-cols-2 gap-4">
            ...
            >
              <Input
                className="w-[100%] py-2 bg-gray-100"
                placeholder="Enter your branch contact"
              />
            </Form.Item>
            <Form.Item
              name="branchEmail"
