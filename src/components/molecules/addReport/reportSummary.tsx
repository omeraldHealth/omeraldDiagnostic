...
const ReportSummaryComp: React.FC<ReportSummaryCompProps> = ({
  profile,
  style,
  handleSuccess,
  isManual,
        ...
        <section>
          <section className="grid grid-cols-3 gap-2">
            <aside>
              ...
              <ProfileSummaryCard
                title="Report Name"
                value={reportData?.reportData?.reportName}
              />
              ...
              {!isManual ? (
                ...
                <ProfileSummaryCard
                  title="Report Uploaded"
                  value={reportData?.reportData?.parsedData?.testName}
                />
              )}
            </aside>
            <aside>
              ...
              <ProfileSummaryCard
                ...
                value={reportData?.patient?.contact?.phone}
              />
              <ProfileSummaryCard
                title="Patient Email"
                value={reportData?.patient?.contact?.email}
              />
            </aside>
            <aside>
              ...
              <ProfileSummaryCard
                ...
                value={reportData?.diagnosticCenter?.name}
              />
              <ProfileSummaryCard
                title="Diagnostic Branch"
                value={reportData?.diagnosticCenter?.branch?.name}
              />
              <ProfileSummaryCard
                title="Diagnostic Pathalogist"
                value={reportData?.pathologist?.name}
              />
            </aside>
          </section>
        </section>
