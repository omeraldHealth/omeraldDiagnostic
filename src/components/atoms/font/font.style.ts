...
export const TitleTextStyled = styled.p`
  ...
  screenWidth > 771 &&
  screenWidth < 900 &&
  title.omerald_textStyle_laptop_Title1}
    ${screenWidth &&
  screenWidth > 500 &&
  screenWidth < 770 &&
  title.omerald_textStyle_tab_Title1}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  title.omerald_textStyle_mobile_Title1}
...
export const TitleTextStyled_2 = styled.p`
  ...
  screenWidth > 500 &&
  screenWidth < 770 &&
  title.omerald_textStyle_tab_Title2}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  title.omerald_textStyle_mobile_Title2}
    ${Colors.neutral.black}
`;
...
export const HeaderStyled_1 = styled.p`
  ...
  screenWidth > 771 &&
  screenWidth < 900 &&
  header.omerald_textStyle_laptop_Title1}
    ${screenWidth &&
  screenWidth > 500 &&
  screenWidth < 770 &&
  header.omerald_textStyle_tab_Title1}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  header.omerald_textStyle_mobile_Title1}
    ${Colors.neutral.black}
`;
...
export const HeaderStyled_2 = styled.p`
  ...
  screenWidth > 771 &&
  screenWidth < 900 &&
  header.omerald_textStyle_laptop_Title2}
    ${screenWidth &&
  screenWidth > 500 &&
  screenWidth < 770 &&
  header.omerald_textStyle_tab_Title2}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  header.omerald_textStyle_mobile_Title2}
    ${Colors.neutral.black}
`;
...
export const HeaderStyled_3 = styled.p`
  ...
  screenWidth > 771 &&
  screenWidth < 900 &&
  header.omerald_textStyle_laptop_Title3}
    ${screenWidth &&
  screenWidth > 500 &&
  screenWidth < 770 &&
  header.omerald_textStyle_tab_Title3}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  header.omerald_textStyle_mobile_Title3}
    ${Colors.neutral.black}
`;
...
export const BodyStyled_1 = styled.p`
  ...
  screenWidth > 771 &&
  screenWidth < 900 &&
  body.omerald_textStyle_laptop_Body1}
    ${screenWidth &&
  screenWidth > 500 &&
  screenWidth < 770 &&
  body.omerald_textStyle_tab_Body1}
    ${screenWidth &&
  screenWidth > 200 &&
  screenWidth < 500 &&
  body.omerald_textStyle_mobile_Body1}
