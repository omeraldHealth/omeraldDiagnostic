  ...
  return (
    ...
    >
      ...
      <div className="sm:mt-10 sm:py-4 lg:py-8">
        <HeaderText_2 style="mt-10 sm:mt-0">
      ...
      <section className="lg:flex gap-[4%] sm:gap-[2%] my-[7%] w-[100%] justify-around">
        {helpBusiness.map((help, index) => (
          <div
            key={index}
            className="text-left bg-white my-10 lg:my-0 lg:w-[33%] h-auto p-10 rounded-lg shadow-xl sm:shadow-md"
          >
            {help.icon}
            <TitleText_2 style="my-4">{help.title}</TitleText_2>
            <BodyText_2 style="text-gray-400 my-4">
              {help.description}
            </BodyText_2>
