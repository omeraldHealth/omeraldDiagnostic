...
export function HowItWorks({ section1, section2, section3 }: HowItWorksProps): React.ReactElement {
  return (
      ...
      <div className={`h-auto px-[7%] lg:px-[10%] text-center lg:grid grid-rows-2 ${styles['howItWorks']}`}>
        <section className='flex lg:grid grid-cols-3 justify-between lg:h-[40vh]'>
          ...
          <section className='text-left'>
            <p className='text-[#5D5FEF] my-6 lg:my-0 uppercase font-bold text-sm'>{section1.title}</p>
            <p className='sm:text-[37px] text-[24px] my-6 lg:my-0 font-[600]'>{section1.description}</p>
            <p className='text-[#64607D] my-6 lg:my-0 font-light'>{section1.description}</p>
            <Link href='/signIn'>
          ...
          {/* Section 3 */}
          <section className={section3.isHidden ? 'hidden lg:block' : 'text-left xl:pl-[20%] pr-[20%] pt-[20%]'}>
        ...
        <section className='lg:grid grid-cols-3 justify-between lg:h-[40vh]'>
          ...
          <section className={section3.isHidden ? 'block lg:hidden my-6 lg:my-0 text-left lg:pl-[20%] lg:pr-[20%] lg:pt-[20%]' : ''}>
            <p className='text-[16px] font-[600] my-2'>{section3.title}</p>
            <p className='text-[#64607D] font-light'>{section3.description}</p>
          </section>
