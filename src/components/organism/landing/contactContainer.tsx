  ...
  return (
    ...
    >
      ...
      <div className="my-4 lg:my-2">
        <HeaderText_3 style="text-btnPrimary-600 mx-auto my-4">
          DC Management App
        </HeaderText_3>
      </div>
      {/* Contact via WhatsApp Header */}
      <div className="my-4 lg:my-2">
        <HeaderText_2 style="w-[80%] mx-auto my-4">
          Contact us via WhatsApp
        </HeaderText_2>
      </div>
      {/* App Description */}
      <div className="mb-10">
        <BodyText_2 style="text-gray-400">
          End-to-end Diagnostic centre management in a single solution.
        </BodyText_2>
      </div>
      {/* Message Link */}
      <Link href="/contact" className="flex justify-center">
        <p className="rounded-lg text-white w-[10%] bg-purple-800 px-4 py-3 sm:px-8 sm:py-4">
          Message
        </p>
      </Link>
    </div>
