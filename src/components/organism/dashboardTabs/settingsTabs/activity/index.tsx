...
export const Activity = () => {
  ...
  // @ts-ignore
  const sortedActivities = [...activities].sort((a, b) => new Date(b.updatedTime) - new Date(a.updatedTime));

  return (
    <div className='sdsa'>
        <CommonSettingTable data={sortedActivities} columns={ADMIN_USER_ACTIVITES_COLUMNS}/>
    </div>
  );
};
