...
import { useGetDcBranch, useInvalidateQuery, useUpdateBranch, useUpdateDiagnostic } from "@utils/reactQuery";
...
const UpdateBranch = ({ handleEditBranch, branchId }) => {
    ...
    const { data: branchData, isLoading } = useGetDcBranch({ selectedBranchId: branchId })
    ...
    const handleSubmit = async (e) => {
      ...
      updateBranch.mutate({ recordId: branchId, data: {...formData} }, {
        onSuccess: (resp) => { 
          if (resp?.data) { 
